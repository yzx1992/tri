...
# Parameters
tf.flags.DEFINE_string("test_data", "../gen_class_data/test2/all_raw_data2-20.index", "")
...
tf.flags.DEFINE_string("output_path","../gen_class_data/test2/all_raw_data2-20-pb10000.pre2","")
